...
#how to run: python SelectHalo.py halo_catalog num_limit M_high M_low DwarfMass Plot_dwarfs
#example: $python SelectHalo.py halos_0.0_G.ascii 250 1.25e12 1.2e12 1.0e8 1
...
if __name__ == "__main__":
	...
	parser.add_argument("DwarfLim", type=float)
	...
	DwarfMass=args.DwarfLim


	#to see smaller satellites
	IdDwarfs=IdAll[MvirAll<DwarfMass]
	RvirDwarfs=RvirAll[MvirAll<DwarfMass]
	XDwarfs=XAll[MvirAll<DwarfMass]
	YDwarfs=YAll[MvirAll<DwarfMass]
	ZDwarfs=ZAll[MvirAll<DwarfMass]
	...
	if args.plotDwarfs==1:
		ax.scatter(XDwarfs,YDwarfs,ZDwarfs,c='r',alpha=0.3,marker='o',s=3)
